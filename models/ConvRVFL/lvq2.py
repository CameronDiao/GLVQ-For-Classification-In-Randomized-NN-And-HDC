...
class ConvRVFLUsingLVQ2(ConvRVFL):
    def __init__(self, train_set, classifier, optimizer, epochs, n, ppc, beta, sigma=None):
    ...
    def train(self):
        ...
        self.act_matrix = self.activations(train_features)
    ...
    def score(self, test_set, classifier=None, wrapper=None):
        ...
        w.to(device)
        testloader = torch.utils.data.DataLoader(TensorDataset(act_matrix, test_labels), batch_size=16, num_workers=0)
